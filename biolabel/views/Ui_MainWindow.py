...
from PyQt5.QtGui import QPainterPath, QPainter, QPen, QBrush,QFont, QColor ,QIcon
from PyQt5.QtWidgets import QLabel, QGraphicsRectItem, QApplication, QGraphicsView, QGraphicsScene,QWidget ,QGraphicsItem , QGraphicsPathItem,QDialog,QGraphicsTextItem
from PyQt5 import QtWidgets
import sys
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        MainWindow.setObjectName("MainWindow")
        MainWindow.resize(1023, 773)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowIcon(QIcon('biolabel/icons/icon.png'))
        self.pushButton_23.setText(_translate("MainWindow", "CreateLabel"))
        self.pushButton_21.setText(_translate("MainWindow", "EditLabel"))
        self.pushButton_25.setText(_translate("MainWindow", "DIP"))
        size = QSize(50, 50)
        self.pushButton_23.setStyleSheet("QPushButton { text-align: center; }")
        self.pushButton_23.setIcon(QIcon('biolabel/icons/pen.png'))
        self.pushButton_23.setIconSize(size)
        self.pushButton_21.setIcon(QIcon('biolabel/icons/select.png'))
        self.pushButton_25.setIcon(QIcon('biolabel/icons/edit-image.png'))
