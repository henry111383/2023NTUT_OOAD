...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_23.setIcon(QIcon('C:/GitHub/QQ153/2023_OOAD/biolabel/icons/pen.png'))
        self.pushButton_23.setIconSize(size)
        self.pushButton_21.setIcon(QIcon('../icons/select.png'))
        self.pushButton_25.setIcon(QIcon('../icons/edit-image.png'))
